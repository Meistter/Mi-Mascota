...
export class PetsService {
  ...
  adoptionPets: Pet[] = [    
    ...
    age:2, health:'Buena', location:'Caracas', vaccinated:false, owner_name:'Josue Perez',castrated:true,disease:false,adoptionReason:'No tengo dinero para mantenerlo',remarks:'Es jugueton y muerde todo',
    ...
    age:0.5, health:'Buena', location:'Texas', vaccinated:true, owner_name:'Josue Perez',castrated:false,disease:false,adoptionReason:'Hemos tenido dias dificiles y actualmente no tenemos dinero para mantenerlo y no queremos dejarlo en un refugio',remarks:'En el pasado Max ha tenido episodios ansiedad por el calor donde es necesario llevarlo a un lugar fresco y tener cuidado con el calor en sus patitas',
